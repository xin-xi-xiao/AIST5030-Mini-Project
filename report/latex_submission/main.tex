...
\caption{Comprehensive visualization grid (columns: loss, metrics, energy; rows: dog, backpack, cat). This compact view jointly supports convergence, quality, and geometry analysis.}
\end{figure}

\begin{figure}[t]
\centering
\includegraphics[width=0.98\columnwidth]{assets/qual/qual_all_subjects.png}
\caption{Qualitative baseline-vs-finetuned comparison across all three subjects (top-to-bottom: dog E3, backpack E3, cat E2). Each row uses identical prompts before/after finetuning.}
\end{figure}
...
\texttt{outputs\_realfull\_20260323\_011116};
\texttt{figures/realfull\_20260323\_011116};\newline
\texttt{report/tables/*};
\texttt{report/latex\_submission/assets/tables/integrity\_audit.txt}.
