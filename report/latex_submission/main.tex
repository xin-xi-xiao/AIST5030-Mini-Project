...
\textbf{External validity}: conclusions are valid for the assignment setting (3 subjects, 25 prompts, 800 steps, SD-v1.5); broader generalization requires more subjects and diverse prompts.

\textbf{Future work}: external validity strengthens via more subjects, longer-tail prompts, and higher-res backbones (e.g., SDXL) under the OFT-vs-LoRA protocol.
